    ...
    <div class="row">
        ...
        <div class="col-xs-8">
            <ul class="nav nav-tabs nav-justified">
                ...
                <li role="presentation" class="{{ Request::is('users/*/favorites') ? 'active' : '' }}"><a href="{{ route('users.favorites', ['id' => $user->id]) }}">Followings <span class="badge">{{ $count_favorites }}</span></a></li>
            ...
            @include('users.favolites_list', ['microposts' => $favorites])
